...
public class GenericFastImageSearcher extends AbstractImageSearcher {
     ...
     */
    protected float getDistance(Document document, LireFeature lireFeature) throws UnexpectedException {
    	//TODO: fixed null pointer
    	if (document.getField(fieldName)!= null && document.getField(fieldName).binaryValue().length > 0) {
        	...
        	throw new UnexpectedException("No feature stored in this document! (" + descriptorClass.getName() + ")");
